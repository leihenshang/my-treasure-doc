...
type User struct {
	BaseModel
	Nickname      string     `json:"nickname" gorm:"column:nickname;type:varchar(50);NOT NULL;comment:昵称"`
	...
	UserType      UserType   `json:"userType" gorm:"column:user_type;type:smallint;default:1;NOT NULL;comment:1-普通用户,2管理员,100超级管理员"`
	UserStatus    UserStatus `json:"userStatus" gorm:"column:user_status;type:smallint;default:1;NOT NULL;comment:1-可用,2-不可用,3-未激活"`
