...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.UserStatus = field.NewInt32(tableName, "user_status")
	...
	_user.TokenExpire = field.NewTime(tableName, "token_expire")
...
type user struct {
	...
	UserType      field.Int32  // '1-普通用户,2管理员,100超级管理员'
	UserStatus    field.Int32  // '1-可用,2-不可用,3-未激活'
	Mobile        field.String // '手机号'
	Avatar        field.String // '头像地址'
	Bio           field.String // '个人说明'
	Token         field.String // '登陆token'
	TokenExpire   field.Time   // 'token超时时间'
	LastLoginIP   field.String // '最后登陆ip地址'
	LastLoginTime field.Time   // '最后登陆时间'
...
func (u *user) updateTableName(table string) *user {
	...
	u.TokenExpire = field.NewTime(table, "token_expire")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["token_expire"] = u.TokenExpire
