...
func newDocGroup(db *gorm.DB, opts ...gen.DOOption) docGroup {
	...
	_docGroup.ID = field.NewInt64(tableName, "id")
	_docGroup.UserID = field.NewInt64(tableName, "user_id")
	_docGroup.Title = field.NewString(tableName, "title")
	_docGroup.Icon = field.NewString(tableName, "icon")
	_docGroup.PID = field.NewInt64(tableName, "p_id")
	_docGroup.Priority = field.NewInt32(tableName, "priority")
	_docGroup.DeletedAt = field.NewField(tableName, "deleted_at")
	_docGroup.CreatedAt = field.NewTime(tableName, "created_at")
	_docGroup.UpdatedAt = field.NewTime(tableName, "updated_at")
...
func (d *docGroup) updateTableName(table string) *docGroup {
	...
	d.PID = field.NewInt64(table, "p_id")
